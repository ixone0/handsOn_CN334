...
export default function PatientManagementPage() {
  // 2. ระบุ Type ให้กับ State แทนการใช้ any[]
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSearchTerm(term)
    // 4. TS จะรู้ทันทีว่า patient มี property อะไรบ้าง ทำให้เราเรียกใช้ .patient_name ได้อย่างปลอดภัย
...
(Patient Records)</h1>
      ...
      <div className="mb-4 flex justify-between items-center">
        <input
          ...
          className="px-4 py-2 border rounded-lg w-1/3 focus:outline-none focus:ring-2 
focus:ring-blue-500"
        />
